...
create recursive view adv_stat as
    select advertiser_name, sum(case time_view > 0 then time_view end)
    from advertising
    group by advertiser_name

create index adv_stat_id on device_adv_stat(advertiser_name)
